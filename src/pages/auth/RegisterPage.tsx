        ...
        <div className="w-full max-w-sm py-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-slate-400 text-sm">
              Únete a Huecko y empieza a coordinar.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-4">
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  {...register('nombre')}
                  className={`${inputBaseClass} pl-10 pr-4 ${errors.nombre ? inputErrorClass : inputDefaultClass}`}
                />
              </div>
              {errors.nombre && (
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`${inputBaseClass} pl-10 pr-12 ${errors.confirmPassword ? inputErrorClass : inputDefaultClass}`}
                />
                <button
                  type="button"
            ...
            <button
              ...
              className="
                w-full py-3 rounded-xl font-semibold text-sm mt-4
